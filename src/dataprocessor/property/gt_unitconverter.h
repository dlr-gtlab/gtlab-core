...
//        return value / factors[GtUnit];
//    }
//    else if (summands.contains(GtUnit))
//    {
//        if (success != 0)
//        {
//            *success = true;
...
void GtUnitConverter<T>::initialize()
{
    ...
    lengthFac["mi"] = 1. / 1609.344;
    lengthFac["nmi"] = 1. / 1852.;
    ...
    areaFac["km^2"] = 0.000001;
    areaFac["m^2"] = 1.0;
    areaFac["dm^2"] = 100.0;
    areaFac["cm^2"] = 10000.0;
    areaFac["mm^2"] = 1000000.0;
    areaFac["ft^2"] = 1. / 0.3048 / 0.3048;
    areaFac["inch^2"] = 1. / 0.0254 / 0.0254;
    ...
    volumeFac["km^3"] = 0.000000001;
    volumeFac["m^3"] = 1.0;
    volumeFac["dm^3"] = 1000.0;
    volumeFac["cm^3"] = 1000000.0;
    volumeFac["mm^3"] = 1000000000.0;
    volumeFac["l"] = 1000.0;
    volumeFac["ml"] = 1000000.0;
    volumeFac["gal"] = 1. / 0.0254 / 0.0254 / 0.0254 / 231.;
    volumeFac["floz"] = 128. / 0.0254 / 0.0254 / 0.0254 / 231.;
    volumeFac["ft^3"] = 1. / 0.3048 / 0.3048 / 0.3048;
    volumeFac["inch^3"] = 1. / 0.0254 / 0.0254 / 0.0254;
    ...
    volumeFlow["km^3/s"] = pow(10, -3);
    volumeFlow["km^3/min"] = pow(10, -3) * 60.;
    volumeFlow["km^3/h"] = pow(10, -3) * 3600.;
    volumeFlow["m^3/s"] = 1.;
    volumeFlow["m^3/min"] = 1. * 60.;
    volumeFlow["m^3/h"] = 1. * 3600.;
    volumeFlow["dm^3/s"] = 1000.;
    volumeFlow["dm^3/min"] = 1000. * 60.;
    volumeFlow["dm^3/h"] = 1000. * 3600.;
    volumeFlow["l/s"] = 1000.;
    volumeFlow["l/min"] = 1000. * 60.;
    volumeFlow["l/h"] = 1000. * 3600.;
    volumeFlow["ml/s"] = 1000000.0;
    volumeFlow["ml/min"] = 1000000.0 * 60.;
    volumeFlow["ml/h"] = 1000000.0 * 3600.;
    volumeFlow["cm^3/s"] = pow(10, 6);
    volumeFlow["cm^3/min"] = pow(10, 6) * 60.;
    volumeFlow["cm^3/h"] = pow(10, 6) * 3600.;
    volumeFlow["mm^3/s"] = pow(10, 9);
    volumeFlow["mm^3/min"] = pow(10, 9) * 60.;
    volumeFlow["mm^3/h"] = pow(10, 9) * 3600.;
    volumeFlow["gal/s"] = 1. / 0.0254 / 0.0254 / 0.0254 / 231.;
    volumeFlow["gal/min"] = 1. / 0.0254 / 0.0254 / 0.0254 / 231. * 60.;
    volumeFlow["gal/h"] = 1. / 0.0254 / 0.0254 / 0.0254 / 231. * 3600.;
    volumeFlow["floz/s"] = 128. / 0.0254 / 0.0254 / 0.0254 / 231.;
    volumeFlow["floz/min"] = 128. / 0.0254 / 0.0254 / 0.0254 / 231. * 60.;
    volumeFlow["floz/h"] = 128. / 0.0254 / 0.0254 / 0.0254 / 231. * 3600.;
    volumeFlow["ft^3/s"] = 1. / 0.3048 / 0.3048 / 0.3048;
    volumeFlow["ft^3/min"] = 1. / 0.3048 / 0.3048 / 0.3048 * 60.;
    volumeFlow["ft^3/h"] = 1. / 0.3048 / 0.3048 / 0.3048 * 3600.;
    volumeFlow["inch^3/s"] = 1. / 0.0254 / 0.0254 / 0.0254;
    volumeFlow["inch^3/min"] = 1. / 0.0254 / 0.0254 / 0.0254 * 60.;
    volumeFlow["inch^3/h"] = 1. / 0.0254 / 0.0254 / 0.0254 * 3600.;
    ...
    velocityFac["mm/s"] = 1000.0;
    velocityFac["cm/s"] = 100.0;
    velocityFac["dm/s"] = 10.0;
    velocityFac["m/s"] = 1.0;
    velocityFac["km/s"] = 0.001;
    velocityFac["m/min"] = 1.0 * 60.0;
    velocityFac["km/min"] = 0.001 * 60.0;
    velocityFac["dm/min"] = 10.0 * 60.0;
    velocityFac["cm/min"] = 100.0 * 60.0;
    velocityFac["mm/min"] = 1000.0 * 60.0;
    velocityFac["m/h"] = 1.0 * 3600.0;
    velocityFac["km/h"] = 0.001 * 3600.0;
    velocityFac["dm/h"] = 10.0 * 3600.0;
    velocityFac["cm/h"] = 100.0 * 3600.0;
    velocityFac["mm/h"] = 1000.0 * 3600.0;
    velocityFac["mph"] = 3600. / 1609.344;
    velocityFac["kn"] = 3600. / 1852.;
    velocityFac["in/s"] = 1. / 0.0254;
    velocityFac["ft/s"] = 1. / 0.3048;
    ...
    massMomentInertiaFac["lb*ft^2"] = 23.730360404;
    ...
    massFac["dt"] = 0.01;
    massFac["t"] = 0.001;
    massFac["oz"] = 16. / 0.45359237;
    massFac["lbm"] = 1. / 0.45359237;
    massFac["tn. sh."] = 0.0005 / 0.45359237;
    ...
    massFlowFac["oz/s"] = 16. / 0.45359237;
    massFlowFac["lbm/s"] = 1. / 0.45359237;
    massFlowFac["(tn. sh.)/s"] = 0.0005 / 0.45359237;
    ...
    massFlowFac["oz/min"] = 16. / 0.45359237 * 60.;
    massFlowFac["lbm/min"] = 1. / 0.45359237 * 60.;
    massFlowFac["(tn. sh.)/min"] = 0.0005 / 0.45359237 * 60.;
    ...
    massFlowFac["oz/h"] = 16. / 0.45359237 * 3600.;
    massFlowFac["lbm/h"] = 1. / 0.45359237 * 3600.;
    massFlowFac["(tn. sh.)/h"] = 0.0005 / 0.45359237 * 3600.;
    ...
    forceFac["lbf"] = 1. / 0.45359237 / 9.80665;
    forceFac["kp"] = 1. / 9.80665;
    forceFac["Mp"] = 0.001 / 9.80665;
    forceFac["dyn"] = 1e5;
    forceFac["pdl"] = 1. / 0.45359237 / 0.3048;
    ...
    frequencyFac["1/s"] = 1.0;
    frequencyFac["Hz"] = 1.0;
    frequencyFac["1/min"] = 60.0;
    frequencyFac["1/h"] = 3600.0;
    ...
    torqueFac["kp*m"] = 1. / 9.80665;
    torqueFac["lbf*in"] = 1. / 0.45359237 / 9.80665 / 0.0254;
    torqueFac["lbf*ft"] = 1. / 0.45359237 / 9.80665 / 0.3048;
    ...
    pressureFac["psi"] = 0.0254 * 0.0254 / 0.45359237 / 9.80665;
    ...
    energyFac["ft*lbf"] = 1. / 0.45359237 / 9.80665 / 0.3048;
    ...
    // TODO: BTU ist hier nach ISO definiert.
    //       Es gibt andere gebraeuchlichere (!) Umrechnungen. Welche verwenden?
    powerFac["BTU/s"] = 1. / 1055.056;
    powerFac["BTU/min"] = 60. / 1055.056;
    powerFac["BTU/h"] = 3600. / 1055.056;
    powerFac["ft*lbf/s"] = 1. / 0.45359237 / 9.80665 / 0.3048;
    powerFac["ft*lbf/min"] = 60. / 0.45359237 / 9.80665 / 0.3048;
    powerFac["ft*lbf/h"] = 3600. / 0.45359237 / 9.80665 / 0.3048;
    ...
    inertiaFac["lbm*in^2"] = 1. / 0.45359237 / 0.0254 / 0.0254;
    inertiaFac["lbm*ft^2"] = 1. / 0.45359237 / 0.3048 / 0.3048;
    inertiaFac["(tn. sh.)*in^2"] = 0.0005 / 0.45359237 / 0.0254 / 0.0254;
    inertiaFac["(tn. sh.)*ft^2"] = 0.0005 / 0.45359237 / 0.3048 / 0.3048;
    ...
    energyDensityFac["kWs/kg"] = 0.001;
    energyDensityFac["MJ/kg"] = 0.000001;
    energyDensityFac["MWs/kg"] = 0.000001;
    energyDensityFac["kWh/kg"] = 0.001 * energyDensityFac["Wh/kg"];
    ...
    customFac["kJ/mg"] = energyFac["kJ"] * 1.0 / massFac["mg"];
    customFac["kJ/g"] = energyFac["kJ"] * 1.0 / massFac["g"];
    customFac["kJ/dag"] = energyFac["kJ"] * 1.0 / massFac["dag"];
    customFac["kJ/kg"] = energyFac["kJ"] * 1.0;
    customFac["kJ/t"] = energyFac["kJ"] * 1.0 / massFac["t"];
    customFac["MJ/mg"] = energyFac["MJ"] * 1.0 / massFac["mg"];
    customFac["MJ/g"] = energyFac["MJ"] * 1.0 / massFac["g"];
    customFac["MJ/dag"] = energyFac["MJ"] * 1.0 / massFac["dag"];
    customFac["MJ/kg"] = energyFac["MJ"] * 1.0;
    customFac["MJ/t"] = energyFac["MJ"] * 1.0 / massFac["t"];
