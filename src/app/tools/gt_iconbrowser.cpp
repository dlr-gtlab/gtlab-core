...
GtIconBrowser::GtIconBrowser()
{
    ...
    grid->addWidget(MAKE_ICON(turbine));
    ...
    makeSeparator();
    grid->addWidget(MAKE_ICON(fileStep));
    grid->addWidget(MAKE_ICON(pluginSettings));
    grid->addWidget(MAKE_ICON(minimize));
    grid->addWidget(MAKE_ICON(map));
    grid->addWidget(MAKE_ICON(noMap));
    grid->addWidget(MAKE_ICON(exportMap));
    grid->addWidget(MAKE_ICON(carpetPlot));
    grid->addWidget(MAKE_ICON(xyPlot16));
    grid->addWidget(MAKE_ICON(tsDiagram16));
    grid->addWidget(MAKE_ICON(blades));
    grid->addWidget(MAKE_ICON(convergence));
    grid->addWidget(MAKE_ICON(showText));
    grid->addWidget(MAKE_ICON(double16));
    grid->addWidget(MAKE_ICON(int16));
    grid->addWidget(MAKE_ICON(o16));
    grid->addWidget(MAKE_ICON(string16));
    ...
    grid->addWidget(MAKE_ICON(engine));
    grid->addWidget(MAKE_ICON(engineInstallation32));
    grid->addWidget(MAKE_ICON(performanceDesign));
    grid->addWidget(MAKE_ICON(performanceOffDesign));
    grid->addWidget(MAKE_ICON(fluidPort));
    grid->addWidget(MAKE_ICON(fluidPortGroup));
    grid->addWidget(MAKE_ICON(shaftPort));
    grid->addWidget(MAKE_ICON(speedLine));
    grid->addWidget(MAKE_ICON(compressor));
    grid->addWidget(MAKE_ICON(combustor));
