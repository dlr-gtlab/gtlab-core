    ...
    GtDialog(parent)
{
    ...
    setWindowIcon(gt::gui::icon::update());
    ...
    m_checkButton->setIcon(gt::gui::icon::sync());
    ...
    m_updateButton->setIcon(gt::gui::icon::update());
    ...
    cancelButton->setIcon(gt::gui::icon::cancel());
