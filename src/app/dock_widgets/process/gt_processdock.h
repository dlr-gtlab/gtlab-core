...
public:
     ...
     * @return
     */
    static GtPropertyConnection* findConnectionCopy(
     ...
     * @return
     */
    static bool updateConnectionProperties(
        GtPropertyConnection* origCon,
     ...
     * @return
     */
    static bool updateRelativeObjectLinks(GtObject* orig,
                                                        GtObject* copy);
     ...
     * @return
     */
    static GtObject* findEquivalentObject(GtObject *parent,
            GtObject* origObj);
     ...
     * @return
     */
    static GtTask* highestParentTask(GtTask* childTask);
     ...
     * @return
     */
    static GtTask* highestParentTask(GtCalculator* childCalc);
     ...
     * @return
     */
    static GtTask* highestParentTask(GtProcessComponent*
                                                   childComp);
     ...
     * @return
     */
    static QList<GtPropertyConnection*>
     ...
     */
    static void  setOffLostConnectionWarnings(
