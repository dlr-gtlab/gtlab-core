...
In this case, the Python functionality "pickle" is used. This method is therefore restricted to data that [is pickle-capable.](https://docs.python.org/3/library/pickle.html#what-can-be-pickled-and-unpickled)
