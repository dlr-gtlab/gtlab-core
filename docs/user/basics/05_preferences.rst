...
You can access the window for setting the preferences by selecting ``Edit → Preferences`` in the menu bar or with the short cut ``Alt-Enter``.
...
.. _label_chapter_preferences_shortcuts:
