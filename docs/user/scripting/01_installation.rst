...
.. figure:: images/first_start.png
   :width: 208

This opens the Python Module settings page. To reopen it later, go to ``Edit → Preferences → Python``

.. figure:: images/python_env_selection.png
   :width: 401
...
.. figure:: images/python_env_embedded.png
   :width: 401