...
.. image:: /scripting/images/python_task_light.png
   :align: center
   :alt: Python Tasks configuration dialog
   :class: only-light


.. image:: /scripting/images/python_task_dark.png
   :align: center
   :alt: Python Tasks configuration dialog
   :class: only-dark
...
.. image:: /scripting/images/python_task_create_calc_ui_light.gif
   :alt: Demo of configuring a calculator using the user interface
   :width: 100%
   :class: only-light


.. image:: /scripting/images/python_task_create_calc_ui_dark.gif
   :alt: Demo of configuring a calculator using the user interface
   :width: 100%
   :class: only-dark
